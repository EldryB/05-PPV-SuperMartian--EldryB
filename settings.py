...
WINDOW_WIDTH = VIRTUAL_WIDTH * 3.3
...
TEXTURES = {
    ...
    "key_image": pygame.image.load(BASE_DIR / "assets" / "graphics" / "key_image.png"),
}
...
FRAMES = {
    ...
    "key_image": frames.generate_frames(TEXTURES["key_image"], 16, 16),
}
